...
class ManufacturerController extends AbstractController
{
    ...
    public function index(ManufacturerRepository $manufacturerRepository, CategoryRepository $cat): Response
    {
        $manufacturers = $manufacturerRepository->findAll();
        $category = $cat->findAll();
        return $this->render('manufacturer/index.html.twig', compact('manufacturers', 'category'));
        /*
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$manufacturer->getId(), $request->getPayload()->get('_token'))) {
